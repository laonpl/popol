    ...
    <div className="min-h-screen bg-surface-50/40 py-10 px-5">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="rounded-2xl border border-surface-200 bg-white p-6 sm:p-8">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={e => {
                          ...
                          if (val) { const [y, m] = val.split('-'); updateLang(i, 'date', `${y}.${m}`); }
                          else updateLang(i, 'date', '');
                        }}
                        className={INPUT_CLS}
                      />
                    </div>
          ...
          {/* 비밀번호 변경 */}
          {isEmailUser && (
            <Section title="비밀번호 변경" optional>
              <form onSubmit={handleChangePassword} className="space-y-3">
                ...
                <button
                  type="submit"
                  disabled={pwSaving}
                  className="w-full rounded-lg border border-surface-200 py-2.5 text-[14px] font-semibold text-bluewood-700 transition-colors hover:bg-surface-50 disabled:opacity-50"
                >
...
function Section({ title, required, optional, first, children }) {
  return (

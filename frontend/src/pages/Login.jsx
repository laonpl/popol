      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-surface-200 shadow-card p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 py-3 border border-surface-200 rounded-xl text-sm font-medium text-bluewood-700 hover:bg-surface-50 disabled:opacity-50 transition-colors mb-3"
          >
          ...
          <button
            onClick={handleKakao}
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 py-3 rounded-xl text-sm font-medium text-[#3A2929] bg-[#FEE500] hover:bg-[#FDD800] disabled:opacity-50 transition-colors mb-4"
          >
            <svg width="18" height="18" viewBox="0 0 18 18"><path fill="#000000" d="M9 1.5C4.03 1.5 0 4.67 0 8.58c0 2.5 1.62 4.72 4.09 5.99l-.86 3.19c-.06.22.18.4.38.28l3.75-2.48c.53.07 1.08.12 1.64.12 4.97 0 9-3.17 9-7.08S13.97 1.5 9 1.5z"/></svg>
            카카오로 계속하기
          </button>
